...
<div class="content-wrapper mt-3">
  ...
  <div class="container">
    ...
    <div class="card">
      <div class="card-body">
        <h3 style="font-weight: bold;">Data Barang <i class="fas fa-cart-plus"></i></h3>
        <hr>
        <div class="row">
         <button class="btn btn-primary mb-3" data-toggle="modal" data-target="#myModalAdmin">Tambah Barang</button>
